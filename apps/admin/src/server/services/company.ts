...
export async function companyForm(): Promise<CompanyForm | null> {
  ...
  return {
    ...
    footerCreditLabel: company.footerCreditLabel,
    footerCreditName: company.footerCreditName,
    footerCreditUrl: company.footerCreditUrl,
    footerShowLinks: company.footerShowLinks,
    footerShowAddress: company.footerShowAddress,
    footerShowContacts: company.footerShowContacts,
    footerShowSocials: company.footerShowSocials,
    journeyPlacesTitle: company.journeyPlacesTitle,
    journeyPlacesMore: company.journeyPlacesMore,
    journeyCultureTitle: company.journeyCultureTitle,
    journeyCultureMore: company.journeyCultureMore,
    journeyJournalTitle: company.journeyJournalTitle,
    journeyJournalMore: company.journeyJournalMore,
    journeyRelatedTitle: company.journeyRelatedTitle,
    journeyRelatedMore: company.journeyRelatedMore,
...
function profileFields(input: CompanyInput) {
  return {
    ...
    footerCreditLabel: input.footerCreditLabel,
    footerCreditName: input.footerCreditName,
    footerCreditUrl: input.footerCreditUrl,
    footerShowLinks: input.footerShowLinks,
    footerShowAddress: input.footerShowAddress,
    footerShowContacts: input.footerShowContacts,
    footerShowSocials: input.footerShowSocials,
    journeyPlacesTitle: input.journeyPlacesTitle,
    journeyPlacesMore: input.journeyPlacesMore,
    journeyCultureTitle: input.journeyCultureTitle,
    journeyCultureMore: input.journeyCultureMore,
    journeyJournalTitle: input.journeyJournalTitle,
    journeyJournalMore: input.journeyJournalMore,
    journeyRelatedTitle: input.journeyRelatedTitle,
    journeyRelatedMore: input.journeyRelatedMore,
