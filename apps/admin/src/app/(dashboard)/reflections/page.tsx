...
export default async function ReflectionsPage() {
  ...
  return (
    <>
      <PageHeader
        title="Reflections"
        description="What travellers have said. A quote and a quiet attribution — the design has no star ratings and this screen has no field for one."
      />
      <ReflectionsScreen canWrite={canWrite} canDelete={canDelete} trips={trips} />
    </>
  );
}
